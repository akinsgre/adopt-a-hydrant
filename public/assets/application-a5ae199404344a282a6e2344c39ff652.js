...
$(function() {
  var center = new google.maps.LatLng(40.3553473,-80.04949820000002);
  var mapOptions = {
    center: center,
  ...
  var greenMarkerImage = new google.maps.MarkerImage('/assets/markers/green.png',
    size,
    origin,
    anchor
  );
  var redMarkerImage = new google.maps.MarkerImage('/assets/markers/red.png',
    size,
    origin,
    anchor
  );
  var markerShadowImage = new google.maps.MarkerImage('/assets/markers/shadow.png',
